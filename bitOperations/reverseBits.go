...
/**
looping through all 32 bits is necessary because we need to ensure each bit is considered, even if they are leading zeros

NOTE: In binary, each digit (or bit) represents a power of 2. When you divide a binary number by 2, you effectively shift
all bits to the right by one position.
*/
